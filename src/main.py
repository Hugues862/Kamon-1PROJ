...
class Menus:
    def __init__(self):
        ...
        # Text
        texte1 = Label(self.window, text="Bienvenue sur le jeu Kamon",
                       font=('Courrier', 70), fg='black')
        ...
        button3 = Button(frame3, text="Option", font=('Helvetica', 20), borderwidth=(
            20), foreground=("red"), relief='ridge', highlightthickness=(10))
        button3.grid(row=0, column=0, padx=5, pady=5, ipadx=30)

        button4 = Button(frame3, text="Edition", font=('Helvetica', 20), borderwidth=(
            20), foreground=("red"), relief='ridge', highlightthickness=(10))
